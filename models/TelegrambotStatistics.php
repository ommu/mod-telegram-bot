 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_telegrambot_statistics".
 *
 * The followings are the available columns in table 'ommu_telegrambot_statistics':
 * @property string $statistic_key
 * @property integer $flag
 * @property string $note
 */
class TelegrambotStatistics extends CActiveRecord
{
	 ...
	 * @return TelegrambotStatistics the static model class
	 */
	...
	{
		return 'ommu_telegrambot_statistics';
	}
