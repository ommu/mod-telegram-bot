...
<fieldset>
	...
	<div class="clearfix">
		<?php echo $form->labelEx($model,'subscribe_id'); ?>
		<div class="desc">
			<?php echo $form->textField($model,'subscribe_id',array('size'=>11,'maxlength'=>11)); ?>
			<?php echo $form->error($model,'subscribe_id'); ?>
	...
	<div class="clearfix">
		...
		<div class="desc">
			<?php
			$model->status_date = !$model->isNewRecord ? (!in_array($model->status_date, array('0000-00-00','1970-01-01')) ? date('d-m-Y', strtotime($model->status_date)) : '') : '';
			//echo $form->textField($model,'status_date');
