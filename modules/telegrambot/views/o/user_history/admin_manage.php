...
<?php $this->renderPartial('/o/user_history/_search',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Search ?>
...
<div class="grid-form">
<?php $this->renderPartial('/o/user_history/_option_form',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Grid Option ?>

<div id="partial-telegrambot-user-history">
	<?php //begin.Messages ?>
	<div id="ajax-message">
	<?php
	...
	<div class="boxed">
		...
		<?php 
			...
			$this->widget('application.components.system.OGridView', array(
				'id'=>'telegrambot-user-history-grid',
